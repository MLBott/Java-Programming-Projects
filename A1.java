...
public class MyFirstHomeworkFor300 {
	 ...
	 */
	public static double minValue(double[] list) {
		double lowestValue = list[0];
		for (int i = 0; i < list.length; i++) {
			if (list[i] < lowestValue)
				lowestValue = list[i];
		}
		return lowestValue; // TODO: fix this
	}
	...
	public static int minPosition(double[] list) {
		...
		return lowestIndex; // TODO: fix this
	}
	...
	public static int distanceBetweenMinAndMax(double[] list) {
		...
		indexDiffDistance = highestIndex - lowestIndex;
		if (indexDiffDistance < 0)
			indexDiffDistance *= -1;
		return indexDiffDistance; // TODO: fix this
	}
